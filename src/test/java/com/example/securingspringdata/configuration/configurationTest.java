...
/**
 * Configuration test not terminated
 * Fix connection
 */
public class configurationTest {
    ...
    /**
     * Given user with read scope when get foo resource the success
     */
    @Test
    public void givenUserWithReadScope_whenGetFooResource_theSuccess(){
